...
<div class="container-fluid sfondoVerde">
    <div class="row">
            ...
            <div id="showCarousel" class="carousel slide  mt-3">
                <div class="carousel-inner border border-success">
                  <div class="carousel-item active">
                    <img src="https://picsum.photos/100" class="d-block w-100 resized " alt="...">
                  </div>
                ...
                <div class="border border-success sfondoVerde mt-3">
                    <h5 class="card-title border border-success ">Titolo: {{ $announcement->title }}</h5>
